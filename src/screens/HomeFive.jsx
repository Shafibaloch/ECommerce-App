...
<View style={{ flexDirection: 'row', alignItems: 'center'}}>
                ...
                <Text style={{ fontSize: 15,fontWeight:"bold",color:"black",marginLeft:100}}>Checkout </Text>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '40%', marginTop: 20 }}>
                ...
                <Image style={{ width: 20, height: 20, }} source={require('../Assets/Images/Pen.png')} />
            </View>

            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 20 }}>
                <View style={{ width: '60%',borderColor:"grey",elevation:2,height:"120%" }}>
                    <Text style={{justifyContent:"center",alignItems:"center"}}>216 St Paul's Rd, London N1 2LL,  UK Contact :  +44-784232</Text>
                </View>
