    ...
    return (
        ...
        <View style={{ flex: 1, margin: 20 }}>
            ...
            <View style={{ alignSelf: 'center',marginTop:10 }}>
                <Image style={{height:60,width:70}} source={require('../Assets/Images/human.png')} />
            </View>
                ...
                <TextInput
                    ...
                    placeholder='Shafirehman2003@gmail.com'
                />
                ...
                <TextInput
                    ...
                    placeholder='***'
                />
                <Text style={{ marginTop: 10, alignSelf: 'flex-end', fontSize: 15, color: 'red' }}>Change Password</Text>
